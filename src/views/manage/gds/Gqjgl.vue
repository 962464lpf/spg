  ...
  <div>
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="工器具台账" name="first">
        ...
        <div class="fr clearfloat mt10">
          <el-button type="primary" @click="gqjxzStatus = true">新增</el-button>
          <el-button type="primary" @click="pldrStatus = true"
            >批量导入</el-button
          >
        ...
        >
          ...
          <el-table-column prop="mc" label="工器具名称"> </el-table-column>
          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-table :data="props.row.list" style="width: 100%">
                <el-table-column prop="bh" label="编号"> </el-table-column>
                <el-table-column prop="lx" label="类型"> </el-table-column>
                <el-table-column prop="lymc" label="工器具名称">
                </el-table-column>
                <el-table-column prop="lyr" label="领用人"> </el-table-column>
                <el-table-column prop="lysj" label="领用时间">
                </el-table-column>
                <el-table-column prop="ghsj" label="归还时间">
                </el-table-column>
                <el-table-column prop="fzr" label="管理负责人">
                </el-table-column>
              </el-table>
            </template>
          </el-table-column>
          <el-table-column prop="pgdh" label="工单号"> </el-table-column>
          <el-table-column prop="pgsj" label="签发时间"> </el-table-column>
      ...
      <el-tab-pane label="检查记录" name="third">
        <el-form :inline="true">
          ...
          <el-form-item>
            <el-button type="primary">检索</el-button>
            <el-button type="primary">检查登记</el-button>
          </el-form-item>
        </el-form>
        <el-table :data="tableData3" style="width: 100%">
          <el-table-column prop="pgdh" label="检查时间"> </el-table-column>
          <el-table-column prop="pgsj" label="检查人"> </el-table-column>
          <el-table-column prop="rwmc" label="检查情况说明"> </el-table-column>
        </el-table>
      </el-tab-pane>
      <el-tab-pane label="报废记录" name="forth">
        <el-form :inline="true">
        ...
        <el-table :data="tableData3" style="width: 100%">
          <el-table-column prop="pgdh" label="车牌号"> </el-table-column>
          <el-table-column prop="pgsj" label="购置时间"> </el-table-column>
          <el-table-column prop="rwmc" label="报废时间"> </el-table-column>
        </el-table>
      </el-tab-pane>
    </el-tabs>
    <el-dialog
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="gqjxzStatus = false">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="批量导入工器具"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="pldrStatus = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
