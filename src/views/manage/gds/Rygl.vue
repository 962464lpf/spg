<template>
  <div>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="sfzg"
                       label="在岗情况"> </el-table-column>
      <el-table-column prop="zc"
                       label="职称"> </el-table-column>
      <el-table-column prop="zz"
    ...
    <el-dialog title="分配角色"
      ...
      <el-table ref="multipleTable"
        ...
        <el-table-column label="角色名称"
                         prop="jsmc"> </el-table-column>
        <el-table-column prop="jsms"
                         label="角色描述"
                         width="120">
        </el-table-column>
      </el-table>
          ...
          <el-col :span="12">
            <el-form-item label="人员结构">
              <el-select placeholder="请选择">
                ...
                <el-option label="长期职工"
                           value="3">
                </el-option>
                <el-option label="其他用工方式"
                           value="4">
                </el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="13">
            <el-form-item label="职业资格等级">
              <el-select placeholder="请选择">
                ...
                <el-option label="农网配电营业工"
                           value="2">
                </el-option>
                <el-option label="维修电工"
                           value="3">
                </el-option>
              </el-select>
            </el-form-item>
